...
- [Rule book](FSG23_Competition_Handbook_v1.0.pdf)

## Software

- [VScode](https://code.visualstudio.com/) The best IDE for development. Extensions can be found [here](##Vscode-extension)
